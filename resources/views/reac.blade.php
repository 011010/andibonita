...
<body>
    <h1>Formulario</h1>
    <form method="POST" action="{{ route('reac.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div id="sesiones">
            <div class="sesion">
                ...
                <input type="date" name="fecha_sesion[]" value="{{ $reac_1 }}"required>
                <br>
        ...
        <input type="file" name="evidencia_lista[]" accept="image/*,.pdf,.doc,.docx" multiple>
        <br>
